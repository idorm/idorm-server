...
public class CalendarDefaultResponseDto {
    ...
    @ApiModelProperty(position = 8, value= "내용")
    private String content;
    @ApiModelProperty(position = 9, value= "장소")
    private String location;
    @ApiModelProperty(position = 10, value= "참고 링크")
    private String url;

    public CalendarDefaultResponseDto(Calendar calendar) {
