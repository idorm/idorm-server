...
@GroupSequence({OfficialCalendarSaveRequest.class,
        ValidationSequence.NotBlank.class,
        ValidationSequence.NotNull.class,
        ValidationSequence.Size.class,
})
@Schema(title = "공식 일정 저장 요청")
public class OfficialCalendarSaveRequest {
    ...
    public OfficialCalendar toEntity() {
        return OfficialCalendar.builder()
                .inuPostId(this.inuPostId)
