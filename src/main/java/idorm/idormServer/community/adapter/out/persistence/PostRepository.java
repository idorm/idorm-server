...
public interface PostRepository extends JpaRepository<PostJpaEntity, Long> {
	...
	Page<PostJpaEntity> findAllByDormCategoryAndIsDeletedIsFalseOrderByCreatedAtDesc(Character dormCategory,
		Pageable pageable);
	...
	List<PostJpaEntity> findTopPostsByDormCategory(@Param("dormCategory") Character dormCategory);
