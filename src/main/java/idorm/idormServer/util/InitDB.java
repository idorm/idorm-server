...
//         initService.dbInit2();
    ...
    static class InitService {
        ...
        public void dbInit2() {
            ...
            Member member5 = createMember("eee@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "팔공티 먹는 " + nickname);

            Member member6 = createMember("fff@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "스타벅스 먹는 " + nickname);
            Member member7 = createMember("ggg@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "코딩하는 " + nickname);
            Member member8 = createMember("hhh@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "투썸이 좋은 " + nickname);
            Member member9 = createMember("iii@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "코딩이 좋은 " + nickname);
            Member member10 = createMember("jjj@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "노래 부르는 " + nickname);
            Member member11 = createMember("kkk@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "간식 먹는 " + nickname);
            Member member12 = createMember("lll@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "집 가고싶은 " + nickname);
            ...
            Member member21 = createMember("uuu@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "굴러 떨어진 " + nickname);
            Member member22 = createMember("vvv@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "탈주하고 싶은 " + nickname);
            Member member23 = createMember("www@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "울상 짓는 " + nickname);
