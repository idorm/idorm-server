...
//         initService.dbInit2();
    ...
    static class InitService {
        ...
        public void dbInit1() {
            String adminEmail = id + "@inu.ac.kr";
        ...
        public void dbInit2() {
            String nickname = "응철이";
            Member member1 = createMember("aaa@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "자고있는" + nickname);
            Member member2 = createMember("bbb@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "깨어있는" + nickname);
            Member member3 = createMember("ccc@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "졸고있는" + nickname);
            Member member4 = createMember("ddd@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "눈비비는" + nickname);
            Member member5 = createMember("eee@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "팔공티먹는" + nickname);

            Member member6 = createMember("fff@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "스타벅스" + nickname);
            Member member7 = createMember("ggg@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "코딩하는" + nickname);
            Member member8 = createMember("hhh@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "투썸이좋은" + nickname);
            Member member9 = createMember("iii@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "코딩이좋은" + nickname);
            Member member10 = createMember("jjj@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "노래부르는" + nickname);
            Member member11 = createMember("kkk@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "간식" + nickname);
            Member member12 = createMember("lll@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "집가고싶은" + nickname);
            Member member13 = createMember("mmm@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "나는" + nickname);
            Member member14 = createMember("nnn@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "너도" + nickname);
            Member member15 = createMember("ooo@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "우리는" + nickname);
            Member member16 = createMember("ppp@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "따뜻한" + nickname);
            Member member17 = createMember("qqq@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "삐진" + nickname);
            Member member18 = createMember("rrr@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "화내는" + nickname);
            Member member19 = createMember("sss@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "더운" + nickname);
            Member member20 = createMember("ttt@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "크아하는" + nickname);
            Member member21 = createMember("uuu@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "굴러떨어진" + nickname);
            Member member22 = createMember("vvv@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "탈주한 " + nickname);
            Member member23 = createMember("www@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "울상" + nickname);
            Member member24 = createMember("xxx@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "까까머리" + nickname);
            Member member25 = createMember("yyy@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "귀여운" + nickname);
            Member member26 = createMember("zzz@inu.ac.kr", passwordEncoder.encode("aaaaaaa7!"), "사랑스런" + nickname);
